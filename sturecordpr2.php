...
if($query = mysqli_query($conn,$sql)){
    while($allout = mysqli_fetch_assoc($query)){
		...
		$myq = "UPDATE primary_two set ca1 = '$c1', ca2 = '$c2',exam1 = '$e1',total1 = '$total1',ca3 = '$c3', ca4 = '$c4',exam2 = '$e2',total2 = '$total2',ca5 = '$c4', ca6 = '$c6',exam3 = '$e3',total3 = '$total3',ca7 = '$c7', ca8 = '$c8',exam4 = '$e4',total4 = '$total4',ca9 = '$c9', ca10 = '$c10',exam5 = '$e5',total5 = '$total5',grade = '$grade',total_average = '$average',subject_1='ENGLISH',subject_2='MATHEMATICS',subject_3='BASIC SCIENCE',subject_4='BASIC TECHNOLOGY',subject_5='LITERATURE' WHERE general_id = '$id' ";
...
?>
    <div>
        ...
        <a href="composedassep2.php?id=<?=$id?>">
