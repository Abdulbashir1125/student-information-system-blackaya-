...
<head>
    ...
    <link rel="stylesheet" href="userstu_prof.css">
...
<header class="header">
        <div class="containerr">
            <div class="branding">
                ...
                <h1>STUDENT<span class="highlight"> PROFILE</span></h1>

            </div>
            <nav class="nav">
               <!-- <a href="index.php"><button><i class="fas fa-home"></i></button></a> -->
               <a href="studentdashb.php"><button>Back to dashboard</button></a>
...
$sql = "SELECT * FROM registration_aya where id = '$stuid'";
...
Date of Birth : <label for=""><?=$dateofbirth?></label>&nbsp</td>
            ...
            <tr>
                ...
                <td>
                    <a href="stuprofile_update.php?hisid=<?=$stuid;?>">   <button class="btn btn-primary">Any correction to make?</button></a>
