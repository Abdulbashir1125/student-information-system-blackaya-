...
if($query = mysqli_query($conn,$sql)){
    while($allout = mysqli_fetch_assoc($query)){
        ...
        $myq = "UPDATE nursery_two set ca31 = '$c1', ca32 = '$c2',exam31 = '$e1',total31 = '$total1',ca33 = '$c3', ca34 = '$c4',exam32 = '$e2',total32 = '$total2',ca35 = '$c4', ca36 = '$c6',exam33 = '$e3',total33 = '$total3',ca37 = '$c7', ca38 = '$c8',exam34 = '$e4',total34 = '$total4',ca39 = '$c9', ca310 = '$c10',exam35 = '$e5',total35 = '$total5',grade_3 = '$grade',total_average3 = '$average',subject_31='ENGLISH',subject_32='MATHEMATICS',subject_33='BASIC SCIENCE',subject_34='P.H.E',subject_35='GENERAL SPELLINGS' WHERE general_id = '$id' and statusofu!='demote' ";
           if($quer = mysqli_query($conn,$myq)){
           
            $thh = "SELECT * FROM nursery_two where general_id='$id' and statusofu!='demote'";
           if($qrr = mysqli_query($conn,$thh)){
               while($tout = mysqli_fetch_assoc($qrr)){
                ...
                $myq = "UPDATE nursery_two set cumulative_average='$cumulative_average' WHERE general_id = '$id' and statusofu!='demote' ";
                ...
                if($quer = mysqli_query($conn,$myq)){
                 ...
                 if($cumulative_average>=1.0){
                    $promo = "UPDATE registration_aya set promote_decision = 'promote' WHERE id = '$id'";
                    if(mysqli_query($conn,$promo)){
                        echo 'VALID FOR PROMOTION';
                        header("refresh:0");
                    }
                    else{
                        echo 'not validating';
                    ...
                    $promod = "UPDATE registration_aya set promote_decision = 'demote' where id = '$id'";
                    if(mysqli_query($conn,$promod)){
                        echo 'INVALID FOR PROMOTION';
                        header("refresh:0");
                    }
                    else{
                        echo 'invalidating';
...
<header>
        <div class="container">
            <div class="branding">
                ...
                <h1>NURSERY<span class="highlight"> TWO</span></h1>
...
?>
    <div>
        ...
        <a href="nursery2third.php?id=<?=$id?>">
