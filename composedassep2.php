        ...
        if(isset($_POST['relsu_ce'])){
            ...
            if(isset($_POST['relsu_gm'])){
                ...
                if(isset($_POST['rels_phe'])){
                    ...
                    if(mysqli_query($conn,$sql4)){
                        echo '<script>alert("B/TECH C.A has been released to students")</script>';
                    }
                    else{
                        echo 'not released(B/TECH)';
                    }}
                ...
                if(isset($_POST['relsu_phe'])){
                    ...
                    $sql4="UPDATE release_ca set Btech='$phe_CA' WHERE id = 9 ";
                    if(mysqli_query($conn,$sql4)){
                        echo '<script>alert("B/TECH C.A has been un-released from students")</script>';
                    }
                    else{
                        echo 'not updated';
                    }}
    ...
    <header>
        <div class="container">
            <div class="branding">
                ...
                <h1>PRIMARY TWO<span class="highlight"> COMPOSED ASSESSMENT</span></h1>

            </div>
            <nav>
               <a href="sturecordpr2.php?id=<?=$id?>"><button><i class="fas fa-arrow-left"></i></button></a>
