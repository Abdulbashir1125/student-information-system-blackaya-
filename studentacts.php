        ...
        while($getitt = mysqli_fetch_assoc($qrr)){
         $english_ca = $getitt['english'];
          ...
          if($english_ca=='out now'){
            $sell = "SELECT * FROM $class WHERE general_id ='$id' and statusofu!='demote'";
          }
          else{
          ...
          if($math_ca=='out now'){
            $sellm = "SELECT * FROM $class WHERE general_id ='$id' and statusofu!='demote'";
          }
          else{
          ...
          if($bscince_ca=='out now'){
            $sells = "SELECT * FROM $class WHERE general_id ='$id' and statusofu!='demote'";
          }
          else{
          ...
          if($phe_ca=='out now'){
            $sellp = "SELECT * FROM $class WHERE general_id ='$id' and statusofu!='demote'";
          }
          else{
              $not_p =  ' not released yet(phe)';
          }
          if($spelling_ca=='out now'){
            $spell = "SELECT * FROM $class WHERE general_id ='$id' and statusofu!='demote'";
          }
          else{
...
if($hol =='first term'){
    $cas = "SELECT * FROM $class where general_id='$id' and statusofu!='demote'";
...
<body>
    <header>
        ...
        <div class="title" >
            &nbspSTUDENT <span>ACTIVITIES</span> 
        </div>
        <div class="lin">
    <ul type="none">
<a href="studentdashb.php"> <li class="underline" >Back to my dashboard</li></a>
...
if($action == 'release'){
    ...
    <?php
     ...
     elseif($hol == 'Third term'){?>
<?php
$rt = "SELECT promote_decision FROM registration_aya where id = '$id'";
if($tr = mysqli_query($conn,$rt)){
    while($rot = mysqli_fetch_assoc($tr)){
     $dec = $rot['promote_decision'];
    }
}
?>
